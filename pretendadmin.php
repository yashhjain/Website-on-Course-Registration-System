                ...
                "aoColumnDefs": [
                    {
                        ...
                        "mRender": function (data, type, full) {
                            console.log(full);
                            return "<a href=\"updateCourse_admin.php?course_id=" + encodeURIComponent(full['courseid']) + "&amp;course_code="+encodeURIComponent(full['course_code']) + "&amp;department="+encodeURIComponent(full['dept_id']) + "&amp;seats="+encodeURIComponent(full['seats']) + "&amp;course_name="+encodeURIComponent(full['course_name']) + "&amp;about="+encodeURIComponent(full['about']) + "&amp;time="+encodeURIComponent(full['time']) + "&amp;term="+encodeURIComponent(full['term_id']) + "\">" + "Update</a>";
                        }
                    },
                    {
                        "aTargets": [8],
                        "mData": "courseid",
                        "mRender": function (data, type, full) {
                            return "<a href=\"deleteCourses_admin.php?course_id=" + encodeURIComponent(full['courseid']) + "&amp;course_code="+encodeURIComponent(full['course_code']) + "&amp;department="+encodeURIComponent(full['dept_id']) + "&amp;seats="+encodeURIComponent(full['seats']) + "&amp;course_name="+encodeURIComponent(full['course_name']) + "&amp;about="+encodeURIComponent(full['about']) + "&amp;time="+encodeURIComponent(full['time']) + "&amp;term="+encodeURIComponent(full['term_id']) + "\">" + "Delete</a>";
                        }
                    }
                ]
            });
